...
/**
 The base class for all example_test_build modules
 */
...
/**
 example_test_build Platform calls this method on startup.
 */
-(void)startup;

/**
 example_test_build Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 example_test_build Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 example_test_build Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 example_test_build Platform calls this method on resume.
 @param sender The sender of the event.
 */
