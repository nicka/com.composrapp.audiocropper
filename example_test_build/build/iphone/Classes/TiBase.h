...
// in simulator we redefine to format for example_test_build Developer console
...
{\
	NSString * exceptionName = [@"org.example_test_build." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.example_test_build";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIexample_test_buildNativeItemNone = -1, 
	UIexample_test_buildNativeItemSpinner = -2,
	UIexample_test_buildNativeItemProgressBar = -3,
	
	UIexample_test_buildNativeItemSlider = -4,
	UIexample_test_buildNativeItemSwitch = -5,
	UIexample_test_buildNativeItemMultiButton = -6,
	UIexample_test_buildNativeItemSegmented = -7,
	
	UIexample_test_buildNativeItemTextView = -8,
	UIexample_test_buildNativeItemTextField = -9,
	UIexample_test_buildNativeItemSearchBar = -10,
	
	UIexample_test_buildNativeItemPicker = -11,
	UIexample_test_buildNativeItemDatePicker = -12,
	
	UIexample_test_buildNativeItemInfoLight = -13,
	UIexample_test_buildNativeItemInfoDark = -14,
	
	UIexample_test_buildNativeItemDisclosure = -15,
	
	UIexample_test_buildNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all example_test_build instances of
