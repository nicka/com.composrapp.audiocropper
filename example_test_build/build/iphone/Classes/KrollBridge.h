...
@interface example_test_buildObject : KrollCoverageObject {
#else
@interface example_test_buildObject : KrollObject {
#endif
@private
...
extern NSString * example_test_build$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	example_test_buildObject *_example_test_build;
    KrollObject* console;
	BOOL shutdown;
