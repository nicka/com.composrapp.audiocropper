...
//@interface example_test_buildObject : NSObject
//@end

@interface example_test_buildObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[example_test_buildObject class]])
		{
			for (NSString *key in [[(example_test_buildObject*)o modules] allKeys])
			{
