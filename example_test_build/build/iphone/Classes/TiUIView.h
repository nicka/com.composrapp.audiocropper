...
/**
 Base class for all example_test_build views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the example_test_build view hierarchy (such as wrapped iOS UIViews) was touched.
