 ...
 * to send analytic data that can be viewed on the example_test_build Dashboard.
 *
 * For information on getting started with example_test_build Platform Services,
