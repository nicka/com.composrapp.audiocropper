...
//Rare exceptions to indicate a bug in the _example_test_build code (Eg, function that a subclass should have implemented)
...
/**
 The base class for example_test_build proxies.
 */
